        ...
        GFButton(
          onPressed: () {
            ...
            if (controller.formKey.currentState!.saveAndValidate()) {
              controller
                  .updateRemoteUser(controller.listRemoteUsers[index].uid!);
            }
          },
          text: 'Update',
          type: GFButtonType.outline2x,
                  ...
                  return Column(
                    ...
                    children: [
                              ...
                              children: [
                                ...
                                UsersDetailFormEditable(
                                  ...
                                  initialValue: controller
                                      .listRemoteUsers[index].displayName,
                                  name: 'displayNameRemoteUpdate',
                                  prefixIcon: const Icon(
                                    Icons.person,
                                  ),
                                  obscureText: false,
                      ...
                      UsersDetailFormEditable(
                        ...
                        name: 'confirmPasswordRemoteUpdate',
                        prefixIcon: const Icon(
                          Icons.lock,
                        ),
                        obscureText: true,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                FormBuilderCheckbox(
                                  name: 'verifyEmailRemoteUpdate',
                                  initialValue: controller
                                      .listRemoteUsers[index].emailVerified,
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                FormBuilderCheckbox(
                                  ...
                                  name: 'disableUserRemoteUpdate',
                                  initialValue: controller
                                      .listRemoteUsers[index].disabled,
